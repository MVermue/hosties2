...
public OnPluginStart()
{
	...
	AutoExecConfig_SetFile("lastrequest_fruitninja");
	AutoExecConfig_SetCreateFile(true);
	
	// ConVars
	gH_Cvar_FruitNinja_M1 =	 		AutoExecConfig_CreateConVar("sm_fn_m1", "1", "Mode 1 (normal) enabled.", 0, true, 0.0, true, 1.0); // had problems with bool for unknown reason, it uses int but converted to bool.
	FruitNinja_Mode1 = true;
	gH_Cvar_FruitNinja_M2 = 			AutoExecConfig_CreateConVar("sm_fn_m2", "1", "Mode 2 (iPhone like) enabled.", 0, true, 0.0, true, 1.0); // had problems with bool for unknown reason, it uses int but converted to bool.
	FruitNinja_Mode2 = true;
	gH_Cvar_FruitNinja_MinDis = 		AutoExecConfig_CreateConVar("sm_fn_mindis", "100.0", "Minimum distance between fruits' spawn.", 0, true, 50.0, true, 100.0);
	FruitNinja_MinDis = 100.0;
	gH_Cvar_FruitNinja_MaxDis = 		AutoExecConfig_CreateConVar("sm_fn_maxdis", "200.0", "Maximum distance between fruits' spawn.", 0, true, 200.0, true, 400.0);
	FruitNinja_MaxDis = 200.0;
	gH_Cvar_FruitNinja_M1Time = 		AutoExecConfig_CreateConVar("sm_fn_m1_time", "45", "Mode 1's (normal) long.", 0, true, 20.0, true, 120.0);
	FruitNinja_M1Time = 45;
	gH_Cvar_FruitNinja_M2Time = 		AutoExecConfig_CreateConVar("sm_fn_m2_time", "75", "Mode 2's (iPhone like) long.", 0, true, 20.0, true, 120.0);
	FruitNinja_M2Time = 75;
	gH_Cvar_FruitNinja_ExTimes = 		AutoExecConfig_CreateConVar("sm_fn_extra_times", "1", "Enable extra time which added if players' scores are equal.", 0, true, 0.0, true, 1.0); // had problems with bool for unknown reason, it uses int but converted to bool.
	FruitNinja_ExTimes = true;
	gH_Cvar_FruitNinja_ExTime = 		AutoExecConfig_CreateConVar("sm_fn_extra_time", "5", "Extra time which added if players' scores are equal.", 0, true, 3.0, true, 10.0);
	FruitNinja_ExTime = 5;
	gH_Cvar_FruitNinja_ExTimeMax = 	AutoExecConfig_CreateConVar("sm_fn_extra_time_max", "3", "Maximum times that extra time will be added", 0, true, 0.0, true, 5.0);
